...
class ArtisanAgendaScreen extends StatefulWidget {
  const ArtisanAgendaScreen({super.key});
  @override
  State<ArtisanAgendaScreen> createState() => _ArtisanAgendaScreenState();
}

class _ArtisanAgendaScreenState extends State<ArtisanAgendaScreen> {
