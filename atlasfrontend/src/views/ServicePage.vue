...
const SERVICE_CONFIGS = {
  ...
  menuiserie: {
    title:        'Menuisier',
    description:  "Des menuisiers qualifiés pour tous vos projets en bois. Fabrication sur mesure, réparation et installation de portes, fenêtres, placards et plus encore.",
    description2: "Cuisine, dressing, escalier ou simple étagère — nos menuisiers réalisent vos projets avec précision et des matériaux de qualité. Devis gratuit.",
    image:        'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=700&q=80',
    categoryName: 'Menuiserie',
  },
  climatisation: {
    title:        'Climaticien',
    description:  "Installation, entretien et réparation de systèmes de climatisation par des techniciens certifiés. Confort thermique garanti toute l'année.",
    description2: "Split, gainable ou réversible — nos experts en climatisation vous conseillent et interviennent rapidement pour un confort optimal à domicile ou au bureau.",
    image:        'https://images.unsplash.com/photo-1631545806609-bae1b2e66987?w=700&q=80',
    categoryName: 'Climatisation',
  },
  carrelage: {
    title:        'Carreleur',
    description:  "Pose de carrelage intérieur et extérieur par des artisans expérimentés. Sol, mur, salle de bain — des finitions soignées pour un résultat impeccable.",
    description2: "Faïence, grès cérame, mosaïque ou zellige — nos carreleurs maîtrisent toutes les techniques pour sublimer vos espaces avec précision.",
    image:        'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=700&q=80',
    categoryName: 'Carrelage',
  },
  maconnerie: {
    title:        'Maçon',
    description:  "Gros œuvre et petite maçonnerie par des professionnels qualifiés. Construction, rénovation et aménagement avec des matériaux durables.",
    description2: "Murs, fondations, dalles, clôtures ou extensions — nos maçons réalisent tous vos travaux de construction avec rigueur et savoir-faire.",
